...
object MnemonicUtils {
    ...
    private val WORD_LIST = listOf(
        ...
        "common", "company", "concert", "connect", "consider", "control", "convince", "cook", "cool", "copper",
        "copy", "coral", "core", "corn", "corner", "correct", "cost", "cotton", "couch", "country",
        ...
        "manual", "map", "marble", "march", "margin", "marine", "market", "marriage", "mask", "mass",
        ...
        "reply", "report", "represent", "reproduce", "public", "rescue", "resemble", "resist", "resource", "response",
